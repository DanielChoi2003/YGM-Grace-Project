...
int main(int argc, char** argv) {
  ...
  std::vector<std::string> filenames = {"../src/terrorist_edges.csv"};
...
//   }
  ...
  */
  ...
  global_triangle_number = world.all_reduce(local_triangle_number, aggregator);
  ...
  global_max_triangle_centrality = world.all_reduce_max(local_max_triangle_centrality);
